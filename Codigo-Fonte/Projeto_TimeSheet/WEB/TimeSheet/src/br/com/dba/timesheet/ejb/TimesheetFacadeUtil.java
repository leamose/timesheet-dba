...
/**
 * Classe utilitária para TimesheetFacade.
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("TimesheetFacadeUtil: Não foi possíbel obter o endereço IP local usando InetAddress.getLocalHost()!");
