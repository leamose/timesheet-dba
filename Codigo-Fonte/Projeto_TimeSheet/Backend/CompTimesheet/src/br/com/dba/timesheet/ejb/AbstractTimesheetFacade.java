...
public abstract class AbstractTimesheetFacade implements SessionBean, Timesheet {
    ...
    private void validarCampos(TimeSheet pojo)throws ParametroInvalidoException {
//        if (vo.getDataCadastro() == null) {
//            throw new ParametroInvalidoException(
//                    "Campo Data de preenchimento obrigatório.");
//        }
//        if (curiosidade.getTitulo() == null) {
//            throw new ParametroInvalidoException(
//                    "Campo Título de preechimento obrigatório.");
//        }
//        if (curiosidade.getTexto() == null) {
//            throw new ParametroInvalidoException(
//                    "Campo Texto de preenchimento obrigatório.");
//        }
    }
