...
public class FuncionarioConversor implements Conversor<Funcionario, FuncionarioVO> {
	...
	public FuncionarioVO converterPojoParaVo(Funcionario pojo) {
		...
		vo.setChefe_id(converterPojoParaVo(pojo.getChefe_id()));
		...
		vo.setSubstituto(converterPojoParaVo(pojo.getSubstituto()));		
		return vo;
	}
	...
	public Funcionario converterVoParaPojo(FuncionarioVO vo) {
		...
		pojo.setChefe_id(converterVoParaPojo(vo.getChefe_id()));
		...
		pojo.setSubstituto(converterVoParaPojo(vo.getSubstituto()));
		return pojo;
	}
}
