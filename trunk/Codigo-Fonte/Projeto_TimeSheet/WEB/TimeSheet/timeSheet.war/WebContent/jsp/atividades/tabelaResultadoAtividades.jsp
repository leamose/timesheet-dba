<div style="height:370px; padding-bottom: 15px;overflow: auto">	
	<display:table name="form.listaTimeSheetVO" style="width:99.5%;padding-bottom:20px;margin-left: 2px;" 
		...
		requestURI="/atividade/inicio.do" cellspacing="0" htmlId="resultado" rules="cols" decorator="br.com.dba.timesheet.util.TableEstrutura">
