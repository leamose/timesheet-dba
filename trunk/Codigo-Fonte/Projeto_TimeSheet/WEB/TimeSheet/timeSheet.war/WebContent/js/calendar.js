/*
 +-------------------------------------------------------------------+
 |                 H T M L - C A L E N D A R   (v2.14)               |
 |                                                                   |
 | Copyright Gerd Tentler               www.gerd-tentler.de/tools    |
 | Created: May 27, 2003                Last modified: Dec. 24, 2010 |
 +-------------------------------------------------------------------+
...
//--------------------------------------------------------------------------------------------------------
	...
	// error messages
	this.error = ["Ano deve ser 1 - 3999!", "Mês deve ser 1 - 12!"];
...
//========================================================================================================
	...
	this.viewEventEach = function(weekday, color, title, link) {
		...
		var start = this.get_weekday(this.year, days);

		for(i = 1; i < this.mDays[this.month-1]; i++) {
			if((i + start + this.offset - 1) % 7 == weekday) {
